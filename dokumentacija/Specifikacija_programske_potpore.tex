\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\end{packed_item}
				...
				\begin{figure}[H]
					\includegraphics[scale=0.5]{slike/uc.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
					\centering
				...
				\begin{figure}[H]
					\includegraphics[scale=0.5]{slike/uc2.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
					\centering
				...
				\begin{figure}[H]
					\includegraphics[scale=0.5]{slike/uc3.PNG} %veličina slike u odnosu na originalnu datoteku i pozicija slike
					\centering
